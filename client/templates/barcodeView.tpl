...
<div id = 'brush-scroll-view' class = "scroll-box">
			<div id = 'brush-view'>
   </div>
</div>
<div id = "overall-scroll-panel" class = "scroll-box">
			<div id = 'supertree-scroll-panel' class = "scroll-box">
								<div id = 'selected-item-list'>
								</div>
				    <div id = 'supertree-view'>
				    </div>
			</div>
			<div id = 'sorting-scroll-panel' class = "scroll-box">
			</div>
			<div id = 'barcodetree-scrollpanel' class = "scroll-box">
