...
define([
		...
		return Backbone.Model.extend({
				...
				get_x_ticks_object: function () {
						var currentDataSetName = Variables.get('currentDataSetName')
						var xTicksObject = {
								// xTicksValueArray: [0, 28, 57, 88, 118, 149, 179, 210, 241, 271, 302, 332],
								xTicksValueArray: [0, 28, 57, 88, 118, 149, 179, 210, 241, 271, 302, 332, 352, 381, 409, 440, 469, 499, 529, 559, 590, 620, 651, 681, 703, 733],
								// xTicksFormatArray: ['2016 Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sept', 'Oct', 'Nov', 'Dec']
								xTicksFormatArray: ['2016 Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sept', 'Oct', 'Nov', 'Dec', '2017 Jan', 'Febr', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sept', 'Oct', 'Nov', 'Dec', '2018 Jan', 'Febr']
						}
						return xTicksObject
				}
		})
