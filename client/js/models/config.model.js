...
define([
		...
		window.Config = new (Backbone.Model.extend({
				defaults: {
						'NULL_SELECTION': -1,
						'DataSetCollection': {
								'LibraryTree_DailyName': 'LibraryRecordData',
						...
						BARCODETREE_STATE: {
								...
								BARCODETREE_NODENUMBER_SORT: 'NODENUM',
						...
						'EVENTS': {
								//	更新brush选择的视图
								'UPDATE_BRUSH_SELECTION_VIEW': 'update-brush-selection-view',
								//	删除所有基于节点排序的图标
								'REMOVE_ALL_NODE_SORTING_VIEW_ICON': 'remove-all-node-sorting-view-icon',
								//	删除所有排序的图标
								'REMOVE_ALL_ITEM_SORTING_VIEW_ICON': 'remove-all-item-sorting-view-icon',
								//	增加排序视图的图标
								'INIT_ITEM_SORTING_VIEW_ICON': 'init-item-sorting-view-icon',
								//	删除barcodeTree视图中所有的label以及节点
								'REMOVE_ALL_LABELS_NODES': 'remove-all-labels-nodes',
								//	删除sorting视图
								'REMOVE_SORTING_VIEW_ICON': 'remove-sorting-view-icon',
								//  更新sorting视图
								'UPDATE_SORTING_VIEW': 'update-sorting-view',
								//  删除barcodeTree中的节点
								'REMOVE_BARCODE_NODE': 'remove-barcode-node',
								//  增加sorting的icon的信号
