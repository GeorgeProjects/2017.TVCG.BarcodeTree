...
var handleOriginalData = function (request, response) {
  ...
  var linearizedTreeNodeArrayObj = compute_node_location(linearTreeNodeArrayObject, selectedLevels, barcodeWidthArray, barcodeHeight, barcodeNodeInterval)
  ...
  sendTreeNodeArray(originalTreeObjObject, linearizedTreeNodeArrayObj)
  //  更新构建的superTree
